...
var quote = "I Asked ALLAH For Wealth And He Gave Me Islam";
console.log("Muhammad Ali Once Said, \"".concat(quote, "\""));
//~ DONE
//? 5.Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
var famous_person = "Andrew Tate";
var msg = "Do Not Listen To The Advice Of People Who Are Living Lives You Do not Want To Live";
console.log("The Legend ".concat(famous_person, " said, \"").concat(msg, "\""));
//~ DONE
//? 6. Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces
var personName = "\tMuhammad \n Tahir\t";
console.log(personName);
var newName = personName.trim().split("\n").join("");
console.log(newName);
// ~done
...
var favoriteNum = 804;
var Message = "Is My Favorite Number Because Of IMRAN KHAN ";
...
var friends = ["Ali", "Asad", "Zaid", "Junaid", "Saqib"];
for (var i = 0; i < friends.length; i++) {
    console.log(friends[i]);
}
//~done
//?12. Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
var myFriends = ["Asad", "Zaid", "Junaid", "Saqib"];
for (var i = 0; i < myFriends.length; i++) {
    var friendName = myFriends[i];
    var someMsg = friendName + " HAVE YOU COMPLETED YOUR 45 QUESTIONS ASSIGNMENT ";
    console.log(someMsg);
}
//~DONE
13; //? Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
var myCar = ["lambo", "BMW", "Bugatti", "ferrari"];
var features = ["v10engine", "luxurious interior design", "unmatched speed"];
console.log("I love to drive a ".concat(myCar[0], " because she has ").concat(features[0]));
console.log("I love to drive a ".concat(myCar[1], " because she has ").concat(features[1]));
console.log("I love to drive a ".concat(myCar[2], " because she has ").concat(features[2]));
console.log("I love to drive a ".concat(myCar[3], " because she has superb features like ").concat(features));
//~done
//?14. Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
var guests = ["Sir Zia", "Daniyal Nangori", "Ameen Alam", "sir Moiz"];
var invitationMsg = "Your presence at my table would be greatly appreciated. Would you be able to join me for dinner?";
console.log("".concat(guests[0], " ").concat(invitationMsg, "\t\n \n").concat(guests[1], " ").concat(invitationMsg, " \n \n").concat(guests[2], " ").concat(invitationMsg, "\n\n").concat(guests[3], " ").concat(invitationMsg));
//~done
//?15. Changing Guest List: You just heard that one of your guests can’t make the dinner, so you need to send out a new set of invitations. You’ll have to think of someone else to invite.
//*• Start with your program from Exercise 14. Add a print statement at the end of your program stating the name of the guest who can’t make it.
console.log("hey everyone listen, ".concat(guests[2], " won't come to dinner because he has better thing to do to earn dollars"));
guests.pop();
//~DONE
...
var newMsg = "It would be an honor to request your presence for dinner at my place";
console.log("".concat(guests[2], " would also join us so ").concat(newMsg, "\n\n").concat(guests[0], " ").concat(newMsg, "\n \n").concat(guests[1], " ").concat(newMsg, " "));
// ~ done
//*16. More Guests: You just found a bigger dinner table, so now more space is available. Think of three more guests to invite to dinner.
guests.push(" Andrew Tate", " Khabib ", "Elon Musk");
//*• Start with your program from Exercise 15. Add a print statement to the end of your program informing people that you found a bigger dinner table.
console.log("I Want your Attention ".concat(guests.slice(0, 3), " i've just found a bigger table so ").concat(guests.slice(4, 7), " will also join us "));
...
console.log("add ".concat(guests[3], " in the middle of array, and the updated list is"));
console.log(guests);
// //* • Use append() to add one new guest to the end of your list.
guests.push("Thomas Shelby");
console.log("i add ".concat(guests[9], " in the end of array, and the updated list is"));
console.log(guests);
// //*• Print a new set of invitation messages, one for each person in your list.
guests.forEach(function (guests) {
    var myNewMsg = "if you come it would be an honour for me";
    console.log(guests, myNewMsg);
});
//~done
//? 17. Shrinking Guest List: You just found out that your new dinner table won’t arrive in time for the dinner, and you have space for only two guests.
//*• Start with your program from Exercise 16. Add a new line that prints a message saying that you can invite only two people for dinner.
console.log("ohhhh, i  am so sorry i apologize coz i can invite only two people for dinner ");
//*• Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
console.log("total guests are ".concat(guests, " but i do not have enough table so i am gonna remove some of you"));
for (var i = guests.length; i > 2; i--) {
    var removedGuests = guests.shift(2);
    console.log("sorry ".concat(removedGuests, " you will not come ,hope you will not mind"));
}
console.log("updated list");
console.log(guests);
//* • Print a message to each of the two people still on your list, letting them know they’re still invited.
console.log("".concat(guests, " both of you must come coz you are still invited"));
...
var dreamPlaces = ["palestine", "london", "melbourne", "Edinburg", "islamabad"];
//• Print your array in its original order.
console.log("in original order");
console.log(dreamPlaces);
//• Print your array in alphabetical order without modifying the actual list.
console.log("in alphabetical order");
var order = __spreadArray([], dreamPlaces, true).sort();
console.log(order);
...
var unordered = __spreadArray([], dreamPlaces, true).sort().reverse();
console.log(unordered);
// • Show that your array is still in its original order by printing it again
console.log("still in its original order");
console.log(dreamPlaces);
// • Reverse the order of your list. Print the array to show that its order has changed.
var DreamPlaces = ["islamabad", "Edinburg", "melbourne", "london", "palestine"];
console.log(DreamPlaces);
// • Reverse the order of your list again. Print the list to show it’s back to its original order.
console.log("reverse order");
var reverse = __spreadArray([], DreamPlaces, true).reverse();
console.log(reverse);
// • Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.
console.log("in alphabetical order");
var alphabet = __spreadArray([], DreamPlaces, true).sort();
console.log(alphabet);
// • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
console.log("in reverse alphabetical order");
var rev = __spreadArray([], DreamPlaces, true).sort().reverse();
console.log(rev);
//~done
//?19. Dinner Guests: Working with one of the programs from Exercises 14 through 18, print a message indicating the number of people you are inviting to dinner.
var people = "i invited no one because in the end i removed all of them ".concat(guests);
console.log(people);
console.log(guests);
//~done
...
var Places = ["islamabad", "Edinburg", "melbourne", "london", "palestine"];
...
console.log(x < y);
var aCar = "lamborghini";
console.log("my car ".concat(aCar));
...
var myLaptop = "ASUS";
console.log("my laptop ".concat(myLaptop));
...
var myRollNum = 476344;
console.log("my Roll number: ".concat(myRollNum));
...
var ourPM = "Imran Khan";
console.log("our PM ".concat(ourPM));
...
var str2 = "MAZZ ATHER";
var str3 = "mazz ather";
console.log("".concat(str1, "==").concat(str2, " I Predict False"));
console.log(str1 == str2);
console.log("".concat(str1, "==").concat(str3, " I Predict True"));
console.log(str1 == str3);
//• Tests using the lower case function
var test1 = "IMRANKHAN";
console.log("".concat(test1, "==\"imrankhan\" I Predict false"));
console.log(test1 == test1.toLowerCase());
// • Numerical tests involving equality and inequality, greater than and less than, greater than or equal to, and less than or equal to
////equality and inequality
var r = 7;
var s = 17;
console.log("r = ".concat(r, " s = ").concat(s));
...
var q = 10;
var w = 50;
console.log("q = ".concat(q, " w = ").concat(w));
...
var l = 9;
var m = 1;
console.log("l = ".concat(l, " m = ").concat(m));
...
if (favorite_fruits.includes("banana")) {
    console.log("yeah you really liked ".concat(favorite_fruits[1]));
}
else {
    console.log("".concat(favorite_fruits[1], " fruit is not in your list"));
}
...
if (favorite_fruits.includes("mango")) {
    console.log("yeah you really liked ".concat(favorite_fruits[2]));
}
else {
    console.log("".concat(favorite_fruits[2], " fruit is not in your list"));
}
...
if (favorite_fruits.includes("apple")) {
    console.log("yeah you really liked ".concat(favorite_fruits[0]));
}
else {
    console.log("".concat(favorite_fruits[0], " fruit is not in your list"));
}
// ~done
...
var new_users = ["Daniyal_nagori", "sir_zya", "ali", "mazz", "khalid"];
for (var _a = 0, new_users_1 = new_users; _a < new_users_1.length; _a++) {
    ...
    if (current_users.includes(new_user.toLowerCase())) {
        console.log("".concat(new_user, " username is not available you will need to enter a new username"));
    }
    else {
...
var pizzas = ["fajita", "bbq", "pepperoni"];
for (var i = 1; i <= 1; i++) {
    console.log(pizzas);
}
// • Modify your for loop to print a sentence using the name of the pizza instead of printing just the name of the pizza. For each pizza you should have one line of output containing a simple statement like I like pepperoni pizza.
for (var i = 1; i <= 1; i++) {
    console.log("I like ".concat(pizzas[1], " pizza"));
}
// • Add a line at the end of your program, outside the for loop, that states how much you like pizza. The output should consist of three or more lines about the kinds of pizza you like and then an additional sentence, such as I really love pizza!
console.log("i love these ".concat(pizzas, "  pizzas so so so much and i wanna talk about a lot but due to short time i am gonna stop here "));
//~done
...
console.log(" A ".concat(Animals[1], " would make a cute pet"));
console.log(" A ".concat(Animals[2], " would make a naughty pet"));
// • Add a line at the end of your program stating what these animals have in common. You could print a sentence such as Any of these animals would make a great pet!
console.log("".concat(Animals, " are human friendly"));
//~done
//?36. T-Shirt: Write a function called make_shirt() that accepts a size and the text of a message that should be printed on the shirt. The function should print a sentence summarizing the size of the shirt and the message printed on it. Call the function.
var makeshirt = function (size, inform) {
    if (size === void 0) { size = "medium"; }
    if (inform === void 0) { inform = "this shirt is amazing"; }
    return "my shirt size is ".concat(size, " and i wanna say that ").concat(inform);
};
{
...
var makeshirts = function (size, inform) {
    if (size === void 0) { size = "large"; }
    if (inform === void 0) { inform = "I Love Typescript"; }
    return "yours shirt's size is ".concat(size, " and your shirt print says ").concat(inform);
};
...
var magician_names = ["A.K Mujahid", "simon", "david", "helen"];
function showMagician(magician_names) {
    for (var i = 1; i < magician_names.length; i++) {
        return;
    }
}
...
var magicians = ["A.K Mujahid", "simon", "david", "helen"];
var greatMagician = magicians.map(function (magician) { return magician + " the Great"; });
...
var newArr = ["ali", "ahmed", "saqib", "khalid"];
...
function sandwhich() {
    ...
    console.log("order sandwhich ".concat(items));
}
