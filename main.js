...
var msg = "Do Not Listen To The Advice Of People Who Are Living Lives You Don't Want To Live";
...
var Names = ["ali", "Asad", "Zaid", "Junaid", "Saqib"];
console.log(Names[0]);
console.log(Names[1]);
console.log(Names[2]);
console.log(Names[3]);
...
var car = ["lambo", "BMW", "Bugatti", "ferrari"];
var list = ["v10engine", "luxurious interior design", "unmatched speed"];
for (var i = 1; i < car.length; i++) {
    console.log("i would like to own a ".concat(car[0], " because she has ").concat(list));
}
//~done
//?14. Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
var guests = ["Sir Zia", "Daniyal Nangori", "Ameen ALAM"];
var invitationMsg = "Your presence at my table would be greatly appreciated. Would you be able to join me for dinner?";
for (var a = 1; a < guests.length; a++) {
...
console.log("Attention ".concat(guests.slice(0, 3), " i've just found a bigger table so ").concat(guests.slice(3, 6), " will also join us "));
...
guests.shift(0);
console.log(guests);
console.log("I'm so sorry, but i can not invite you ".concat(guests[0]));
guests.shift();
console.log("remaining guests are ".concat(guests));
console.log("I'm so sorry, but i can not invite you ".concat(guests[0]));
guests.shift();
console.log("remaining guests are ".concat(guests));
console.log("I'm so sorry, but i can not invite you ".concat(guests[0]));
...
var alphaet = __spreadArray([], DreamPlaces, true).sort();
console.log(alphaet);
// • Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
var unalphabet = __spreadArray([], DreamPlaces, true).sort().reverse();
console.log(unalphabet);
//~done
//?19. Dinner Guests: Working with one of the programs from Exercises 14 through 18, print a message indicating the number of people you are inviting to dinner.
var totalpplz = "i invited no one because in the end i removed all of them ".concat(guests);
...
console.log("i love pizzas sooooo much and i wanna talk about a lot but due to short time i am gonna stop here ");
//~done
...
var dog = Animals[0];
console.log("".concat(dog, " would make a great pet. "));
var cat = Animals[1];
console.log("".concat(cat, " would make a cute pet. "));
var duck = Animals[2];
console.log("".concat(duck, " would make a naughty pet . "));
...
function makeshirt(size, inform) {
    if (size === void 0) { size = "medium"; }
    if (inform === void 0) { inform = "this shirt is amazing"; }
    console.log("my shirt size is ".concat(size, " and i wanna say that ").concat(inform));
}
makeshirt();
//~done
// ? 37. Large Shirts: Modify the make_shirt() function so that shirts are large by default with a message that reads I love TypeScript. Make a large shirt and a medium shirt with the default message, and a shirt of any size with a different message.
function makeshirts(size, inform) {
    if (size === void 0) { size = "large"; }
    if (inform === void 0) { inform = "I Love Typescript"; }
    console.log("yours shirt's size is ".concat(size, " and your shirt print says ").concat(inform));
}
makeshirts();
...
var karachiPakistan = city_country("karachi", "Pakistan");
var romeItaly = city_country("rome", "italy");
...
var album1 = make_album("imran khan", "naya pakistan");
var album2 = make_album("arijit singh", "ohh my love");
var album3 = make_album("ali zafar", "psl");
console.log(album1);
console.log(album2);
console.log(album3);
//~done
...
function myCars(manufacturer, model_name) {
    return { manufacturer: manufacturer, model_name: model_name };
}
var modified = myCars("\"lamborghini\" \"aventandor\"");
